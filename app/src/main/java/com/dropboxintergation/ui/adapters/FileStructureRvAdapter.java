package com.dropboxintergation.ui.adapters;
 ...
 */
public class FileStructureRvAdapter extends RecyclerView.Adapter<FileStructureRvAdapter.FileStructureHolder> {
    ...
    public FileStructureRvAdapter(Picasso picasso, Callback callback) {
        mPicasso = picasso;
        mCallback = callback;
    }

    @Override
    public FileStructureHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        Context context = viewGroup.getContext();
        View view = LayoutInflater.from(context)
                .inflate(R.layout.files_item, viewGroup, false);
        return new FileStructureHolder(view);
    }

    @Override
    public void onBindViewHolder(FileStructureHolder fileStructureHolder, int i) {
        fileStructureHolder.bind(mFiles.get(i));
    }
    ...
    public void add(Metadata item){
        mFiles.add(item);
        notifyItemChanged(mFiles.size()-1);
    }
    ...
    public class FileStructureHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        private final TextView mTextView;
        private final ImageView mImageView;
        private Metadata mItem;

        public FileStructureHolder(View itemView) {
            super(itemView);
